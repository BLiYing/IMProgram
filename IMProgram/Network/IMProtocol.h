...
extern NSString * const kIMTypeMsgHidden;
extern NSString * const kIMTypeVoiceTranscript; ///< 语音转文字结果（服务端识别；只推给请求者，见 IMServer docs/VOICE_TRANSCRIBE_DESIGN.md §3.2） ///< 「仅为我删除」多设备同步（任务2）：本人另一端删了某条 → 本端物理移除
